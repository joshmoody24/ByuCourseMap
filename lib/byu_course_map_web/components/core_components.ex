defmodule ByuCourseMapWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ByuCourseMapWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ByuCourseMapWeb.Gettext, "errors", msg, opts)
    end
  end
